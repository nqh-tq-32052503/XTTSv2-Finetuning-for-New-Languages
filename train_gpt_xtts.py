...
def train_gpt(metadatas, num_epochs, batch_size, grad_acumm, output_path, max_audio_length, max_text_length, lr, weight_decay, save_step):
    ...
    # DVAE files
    DVAE_CHECKPOINT_LINK = "checkpoints/XTTS_v2.0_original_model_files/dvae.pth"
    MEL_NORM_LINK = "checkpoints/XTTS_v2.0_original_model_files/mel_stats.pth"
    ...
    TOKENIZER_FILE_LINK = "checkpoints/XTTS_v2.0_original_model_files/vocab.json"
    XTTS_CHECKPOINT_LINK = "checkpoints/XTTS_v2.0_original_model_files/model.pth"
    XTTS_CONFIG_LINK = "checkpoints/XTTS_v2.0_original_model_files/config.json"
